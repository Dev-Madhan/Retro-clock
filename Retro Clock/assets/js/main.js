...
const hour = document.getElementById('clock-hour'),
      minutes = document.getElementById('clock-mins')
...
const dateDayWeek = document.getElementById('date-day-week'),
      ...
      textHour = document.getElementById('txt-hour'),
      textMinutes = document.getElementById('txt-mins'),
      textAmPm = document.getElementById('txt-ampm')
